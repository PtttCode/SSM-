...
<div class="col-sm-3 col-md-2 sidebar" id="patir_sidebar_left" role="tablist" aria-multiselectable="true">
    <ul class="nav nav-pills nav-stacked emp_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-sidebar" id="collapse_emp">
    ...
    <ul class="nav nav-pills nav-stacked dept_sidebar">
        <li role="presentation" class="active">
            ...
            <ul class="nav nav-sidebar" id="collapse_dept">
